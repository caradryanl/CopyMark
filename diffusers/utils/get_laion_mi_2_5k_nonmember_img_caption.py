...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default="datasets/laion-mi-info/laion_mi_non_members_metadata.parquet")
    parser.add_argument("--target-eval", type=str, default="datasets/laion-mi-nonmember-eval/")
    parser.add_argument("--target-test", type=str, default="datasets/laion-mi-nonmember-test/")
