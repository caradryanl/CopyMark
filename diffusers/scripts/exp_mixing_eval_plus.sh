python scripts/train_secmi.py --model-type coco100_laion0_plus --ckpt-path models/stable-diffusion-v1-5/ --member-dataset laion-aesthetic-eval --holdout-dataset coco2017-eval --batch-size 32
python scripts/train_pia.py --model-type coco100_laion0_plus --ckpt-path models/stable-diffusion-v1-5/  --member-dataset laion-aesthetic-eval --holdout-dataset coco2017-eval --batch-size 32
