...
python scripts/train_secmi.py --model-type coco25_laion75_plus --ckpt-path models/stable-diffusion-v1-5/ --member-dataset laion-aesthetic-eval --holdout-dataset coco2017_eval_25_laion_mi_nonmember_eval_75 --batch-size 32
python scripts/train_pia.py --model-type coco25_laion75_plus --ckpt-path models/stable-diffusion-v1-5/  --member-dataset laion-aesthetic-eval --holdout-dataset coco2017_eval_25_laion_mi_nonmember_eval_75 --batch-size 32
