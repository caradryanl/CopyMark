...
python scripts/train_secmi.py --model-type coco50_laion50_plus --ckpt-path models/stable-diffusion-v1-5/ --member-dataset laion-aesthetic-eval --holdout-dataset coco2017_eval_50_laion_mi_nonmember_eval_50 --batch-size 32
python scripts/train_pia.py --model-type coco50_laion50_plus --ckpt-path models/stable-diffusion-v1-5/  --member-dataset laion-aesthetic-eval --holdout-dataset coco2017_eval_50_laion_mi_nonmember_eval_50 --batch-size 32
