...
python scripts/train_secmi.py --model-type sdxl --ckpt-path ../models/diffusers/CommonCanvas-XL-C/ --member-dataset commoncatalog-2-5k --holdout-dataset laion-aesthetic-2-5k --batch-size 16
python scripts/train_pia.py --model-type sdxl --ckpt-path ../models/diffusers/CommonCanvas-XL-C/  --member-dataset commoncatalog-2-5k --holdout-dataset laion-aesthetic-2-5k --batch-size 16
